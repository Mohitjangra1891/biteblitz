...
class textField_widget extends StatefulWidget {
  const textField_widget({
    ...
    this.isreadOnly = false, // Default is to apply formatting
  });
  ...
  final bool isreadOnly; // New parameter to toggle formatter
...
class NumericTextField extends StatefulWidget {
  ...
  @override
  State<NumericTextField> createState() => NumericTextFieldState();
}

class NumericTextFieldState extends State<NumericTextField> {
  final FocusNode _focusNode = FocusNode();
  bool _hasError = false; // Track error state
      ...
      children: [
        ...
        TextFormField(
          ...
          inputFormatters: [
            ...
            LengthLimitingTextInputFormatter(widget.maxNumbers ?? 10), // Limits input to 10 characters
          ],
          focusNode: _focusNode,
          controller: widget.controller,
          autofocus: false,
